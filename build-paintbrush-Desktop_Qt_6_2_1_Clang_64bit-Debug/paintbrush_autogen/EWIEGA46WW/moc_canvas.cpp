...
QT_MOC_LITERAL(7, 17), // "canvasSizeChanged"
QT_MOC_LITERAL(25, 0), // ""
QT_MOC_LITERAL(26, 4) // "int&"

    },
    "Canvas\0canvasSizeChanged\0\0int&"
};
...
void Canvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->canvasSizeChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Canvas::canvasSizeChanged)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Canvas, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<int &, std::false_type>, QtPrivate::TypeAndForceComplete<int &, std::false_type>
...
// SIGNAL 0
void Canvas::canvasSizeChanged(int & _t1, int & _t2)
{
