...
QT_MOC_LITERAL(20, 0), // ""
QT_MOC_LITERAL(21, 8) // "ToolMode"

    },
    "Toolbar\0toolChanged\0\0ToolMode"
};
...
void Toolbar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->toolChanged((*reinterpret_cast< ToolMode(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Toolbar::*)(ToolMode );
...
, QtPrivate::TypeAndForceComplete<Toolbar, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<ToolMode, std::false_type>
...
// SIGNAL 0
void Toolbar::toolChanged(ToolMode _t1)
{
